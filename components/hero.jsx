...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-black text-white pt-20 pb-32 sm:pt-32 sm:pb-40">
      {/* Decorative elements */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <svg
          className="absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] -translate-x-1/2 stroke-gray-700"
          aria-hidden="true"
        >
          <defs>
            <pattern
      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl mx-auto md:max-w-none">
            <div className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-sm font-medium mb-6 animate-fade-in-up">
              <svg
                viewBox="0 0 24 24"
                fill="none"
            ...
            <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl animate-fade-in-up animation-delay-150">
              ...
              <span className="relative">
                ...
                <span className="absolute -bottom-1.5 left-0 h-1.5 w-full bg-gradient-to-r from-purple-500 to-purple-700 rounded-full"></span>
              </span>
              {" "}with Intelligence
            </h1>
            <p className="mb-8 text-lg text-gray-300 animate-fade-in-up animation-delay-300">
            ...
            {/* Stats */}
            <div className="mt-12 grid grid-cols-3 gap-4 rounded-xl border bg-black/50 backdrop-blur-sm p-6 shadow-lg animate-fade-in-up animation-delay-600">
          ...
          <div className="relative mt-10 md:mt-0 animate-fade-in-up animation-delay-300">
            ...
            <div
              ref={imageRef}
              className="hero-image relative rounded-2xl border-4 border-black bg-black p-2 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-3xl"
            >
              <div className="absolute -right-4 -top-4 flex h-20 w-20 items-center justify-center rounded-full bg-purple-600 text-2xl font-black text-white shadow-lg">
                NEW
              </div>
              <Image
                src="/banner.jpeg"
